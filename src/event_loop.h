...
#define EVENT_TYPE_LIST \
    ...
    EVENT_TYPE_ENTRY(STACK_SELECTOR_SELECTED) \
    EVENT_TYPE_ENTRY(STACK_SELECTOR_ANCHOR_CHANGED) \
    EVENT_TYPE_ENTRY(COMMAND_PALETTE_ACTION) \
    EVENT_TYPE_ENTRY(SPACE_WORKFLOW_REQUEST) \
    EVENT_TYPE_ENTRY(DAEMON_MESSAGE) \
    EVENT_TYPE_ENTRY(STATUS_ISLAND_REFRESH)
